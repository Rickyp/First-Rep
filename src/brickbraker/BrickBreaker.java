...
public class BrickBreaker extends JPanel implements KeyListener, ActionListener, Runnable {
    ...
    private boolean booPausa = false; //Inicializo la variable de pausa en falso
    
    //Declaro y creo la imagen de Pausa
    private Image imgPaused = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("pausa.png"));
    
    //Declaro y creo la imagen del Menu
    private Image imgMenu = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("breakingBadMenu.jpg"));
...
// ///////..... HANDLING KEY EVENTS................//
    ...
    public void keyPressed(KeyEvent e) {
        ...
        //Para mover la barra a la izquierda
        if (keyCode == KeyEvent.VK_LEFT) {
            left = true;
        }

        //Para mover la barra a la derecha
